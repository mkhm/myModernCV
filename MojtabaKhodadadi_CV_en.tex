...
%\subsection{Other}
\cventry{2011 -- 2013}{Electronic Content Management System (eCMS)}{Isfahan Science \& Technology Town (ISTT)}{}{Iran}{
...
\item \comment{\textbf{Proficient} with }NumPy, Pandas, Matplotlib, Scikit-learn, SciPy, VPython, Dask, NetworkX, Graph-tool\comment{, Snap}, BLZ, Blosc, Bcolz.
\end{itemize}}
\vspace*{-0.4cm}
%\vspace{-1ex}
%\cvitem{Fortran}{
...
\cvitem{Other}{Familiar with GIT, Fortran, PHP, Javascript, AJAX, C++, LaTex, HTML, CSS, SQL, Wordpress, Drupal.}
