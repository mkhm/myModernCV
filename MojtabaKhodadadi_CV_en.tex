...
\begin{itemize}
\item Working on ion channel data to make a classification between different potential difference.
\item Estimating number of molecular vibrational modes contributing thermal energy to pigment activation using least squares method.
\end{itemize}
}
\subsection{Computer related}
