...
%\subsection{Physics related}
\cventry{Nov 2016 -- \\Feb 2017\hspace{.27cm}}{Visiting Scientist}{under supervision of \MYhref[darkblue]{http://users.ictp.it/~marsili/}{Prof. Matteo Marsili}}{\MYhref[departmentColor]{https://www.ictp.it/research/qls.aspx}{Quantitative Life Sciences section}, \MYhref[universityColor]{http://ictp.it/}{International Centre for Theoretical Physics (ICTP)}}{Trieste, Italy}{}

\cventry{Sep -- Nov 2016}{Visiting Researcher}{under supervision of \MYhref[darkblue]{http://cs.ipm.ac.ir/~mzare/}{Dr. Marzieh Zare}}{\MYhref[departmentColor]{http://cs.ipm.ac.ir/}{School of Computer Science}, \MYhref[universityColor]{http://ipm.ac.ir/}{Institute for Research in Fundamental Sciences (IPM)}}{Tehran, Iran}{Fields of research: Data Analysis, Machine Learning, Computational Neuroscience, Complex Systems.
	\begin{itemize}
...
\cventry{May -- Sep 2016}{Graduate Researcher (ICTP Diploma's Thesis)}{under supervision of \MYhref[darkblue]{http://users.ictp.it/~marsili/}{Prof. Matteo Marsili}}{\MYhref[departmentColor]{https://www.ictp.it/research/qls.aspx}{Quantitative Life Sciences section}, \MYhref[universityColor]{http://ictp.it/}{International Centre for Theoretical Physics (ICTP)}}{Trieste, Italy}{Fields of research: Keyword Extraction, Data Analysis, Complex Systems.
	\begin{itemize}
		\item Implementing the Critical Variable Selection (CVS) algorithm in Python.
		\item Designing and building a keyword extraction tool based upon CVS. 
	\end{itemize}
}
