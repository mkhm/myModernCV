...
\address{Room 213, Old SISSA building, ICTP, Strada Costiera, 11}{34151, Trieste, Italy}{}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
...
\cvitem{M.Sc., IUT}{Computational Physics (20, \%100), Advanced Statistical Mechanics (19.1, \%96), \newline{} Advanced Statistical Mechanics II containing structure \& dynamics of networks and stochastic processes (20, \%100). \MYhref[blue]{https://en.wikipedia.org/wiki/Academic_grading_in_Iran}{\gradingSystem}} % \newline{} Grades are out of 20.
