...
\cvlistdoubleitem{Computational Social Science}{Machine Learning}
...
\cventry{2010, 2015}{Isfahan University of Technology Dean Award}{}{\comment{Dr. Modarres-Hashemi, }President of IUT}{Isfahan, Iran}{} % Mahmood Modarres-Hashemi
...
\cventry{2010 -- Peresent}{Selected as an Exceptional Talent in Physics Department}{}{IUT}{Isfahan, Iran}{}
...
\cventry{2010 \& 2015}{Isfahan University of Technology Scholarship}{}{\comment{Dr. Hamedani Golshan, former President of Isfahan University of Technology, }Isfahan}{Iran}{}
...
\cventry{2014 -- Present}{Graduate Researcher (Master Thesis)}{under supervison of \MYhref[darkblue]{http://shahbazi.iut.ac.ir/}{Dr. F. Shahbazi}}{Physics Dept., Isfahan University of Technology}{Isfahan, Iran}{Fields of research: EEG Data Analysis, Machine Learning, Stochastic Processes, Complex Systems.
\begin{itemize}
...
\subsection{Topics:}
\begin{cvcolumns}
  \cvcolumn{}{\begin{itemize} \item Introduction to Programming \item Introducing IDE: Ninja IDE, Spyder, PyCharm \item Interactive computing with IPython \item Basics of Python Programming \item Python Object Oriented Programming \item Input and Output (I/O) \item Packages and applications \end{itemize}}
  \cvcolumn{}{\begin{itemize} \item Manipulating numerical data with NumPy \item Plotting with Matplotlib in details \item Data Analysis with Pandas \item Network Analysis with NetworkX \item Introduction to HPC \end{itemize}}
\end{cvcolumns}
